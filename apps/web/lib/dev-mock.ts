...
export function mockInboxData(): InboxData {
  const conversations: Conversation[] = [
    ...
    },
    {
      id: "c9",
      name: "David Kim",
      preview: "Je reviens vers toi très vite avec la version signée du contrat.",
    ...
    },
    {
      id: "c3",
      name: "Capucine Roy",
      preview: "Parfait, je regarde le devis et je reviens vers toi rapidement.",
  ...
  const tasks: Task[] = [
    ...
    // ── Tâches SANS client (perso / admin) ────────────────────────────
    {
      id: "t10",
    ...
    {
      id: "t11",
      title: "Déclarer l'URSSAF du trimestre",
      priority: "high",
      dueLabel: "Lundi",
      avatar: FACE(0),
      channel: "gmail",
      ...
      clientConvIds: null,
      dueAtIso: dueIn(3),
      createdAtIso: isoAgo({ days: 6 }),
    },
    {
      id: "t12",
      title: "Réserver le coworking pour la semaine pro",
      priority: "medium",
      dueLabel: "Cette semaine",
      avatar: FACE(0),
      channel: "gmail",
