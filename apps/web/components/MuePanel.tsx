    ...
    >
      <header className="mue2-head">
        ...
        <div className="mue2-disc-wrap">
          ...
          >
            <svg {...stroke} width={14} height={14} className="mue2-disc-ic">
              <path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8z" />
            </svg>
            <span className="mue2-disc-label">
              {(() => {
                ...
                return t || "Nouvelle discussion";
              })()}
            </span>
            <svg {...stroke} width={12} height={12} className="mue2-disc-caret">
              <polyline points="6 9 12 15 18 9" />
            </svg>
          </button>
          {discOpen && (
